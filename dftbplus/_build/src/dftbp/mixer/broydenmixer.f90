# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90" 2
# 10 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"
...
# 53 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"
  !> Contains the necessary data for a Broyden mixer.
  type, extends (TMixerCmplx) :: TBroydenMixerCmplx
    private
    ...
    contains
      procedure :: reset => TBroydenMixerCmplx_reset
      procedure :: mix1D => TBroydenMixerCmplx_mix
  end type TBroydenMixerCmplx
# 53 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"
  !> Contains the necessary data for a Broyden mixer.
  type, extends (TMixerReal) :: TBroydenMixerReal
    private
    ...
    contains
      procedure :: reset => TBroydenMixerReal_reset
      procedure :: mix1D => TBroydenMixerReal_mix
  end type TBroydenMixerReal
# 104 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"


contains

# 109 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"
  ...
  subroutine TBroydenMixerCmplx_init(this, mixerInp)
  ...
  subroutine TBroydenMixerCmplx_reset(this, nElem)
    ...
    class(TBroydenMixerCmplx), intent(inout) :: this
  ...
  subroutine TBroydenMixerCmplx_mix(this, qInpResult, qDiff)
    ...
    call modifiedBroydenMixingCmplx(qInpResult, this%qInpLast, this%qDiffLast, this%aa,&
  ...
  subroutine modifiedBroydenMixingCmplx(qInpResult, qInpLast, qDiffLast, aa, ww, nn, qDiff,&
...
# 109 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"
  ...
  !! norm of the charge difference vector. If the calculated weigth is outside of the
  !! [minWeight, maxWeight] region it is replaced with the appropriate boundary value.
  subroutine TBroydenMixerReal_init(this, mixerInp)

    !> An initialized Broyden mixer on exit
    type(TBroydenMixerReal), intent(out) :: this
  ...
  end subroutine TBroydenMixerReal_init


  !> Makes the mixer ready for a new SCC cycle.
  subroutine TBroydenMixerReal_reset(this, nElem)

    !> Broyden mixer instance
    class(TBroydenMixerReal), intent(inout) :: this
  ...
  end subroutine TBroydenMixerReal_reset
  ...
  !!   real-valued (imaginary parts add up to zero due to the hermitian property) and the linear
  !!   system of equations remains real-valued.
  subroutine TBroydenMixerReal_mix(this, qInpResult, qDiff)
    ...
    call modifiedBroydenMixingReal(qInpResult, this%qInpLast, this%qDiffLast, this%aa,&
        & this%ww, this%iIter, qDiff, this%alpha, this%omega0, this%minWeight, this%maxWeight,&
        & this%weightFac, this%nElem, this%dF, this%uu)

  end subroutine TBroydenMixerReal_mix


  !> Does the real work for the Broyden mixer.
  subroutine modifiedBroydenMixingReal(qInpResult, qInpLast, qDiffLast, aa, ww, nn, qDiff,&
      & alpha, omega0, minWeight, maxWeight, weightFac, nElem, dF, uu)
  ...
  end subroutine modifiedBroydenMixingReal
# 344 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/mixer/broydenmixer.F90"
