# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90" 2
...
# 19 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
  use dftbp_extlibs_scalapackfx, only : scalafx_addl2g, scalafx_cpg2l
# 21 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
  implicit none
...
contains
  ...
  subroutine getOnsiteSpinOrbitEnergy(env, Eatom, rho, denseDesc, xi, orb, species)
    ...
    do iAt = 1, nAtom
      ...
      ! uu block
# 87 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
      call scalafx_cpg2l(env%blacs%orbitalGrid, denseDesc%blacsOrbSqr, iOrbStart, iOrbStart, rho,&
          & tmpBlock(1:nOrbSp, 1:nOrbSp))
# 92 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
      ...
      ! dd block
# 101 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
...
# 107 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
      tmpBlock(:,:) = 0.5_dp * tmpBlock
      do iOrb = 1, orb%nOrbSpecies(iSp)
        tmpBlock(iOrb, iOrb + 1 :) = conjg(tmpBlock(iOrb + 1 :, iOrb))
      end do
...
# 117 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
      call scalafx_cpg2l(env%blacs%orbitalGrid, denseDesc%blacsOrbSqr, nOrb + iOrbStart, iOrbStart,&
          & rho, tmpBlock(1:nOrbSp, 1:nOrbSp))
# 123 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
      Eatom(iAt) = Eatom(iAt)&
  ...
  subroutine addOnsiteSpinOrbitHam(env, xi, species, orb, denseDesc, HSqrCplx)
    ...
    do iAt = 1, nAtom
      ...
      nOrbSp = orb%nOrbSpecies(iSp)
      iOrbStart = denseDesc%iAtomStart(iAt)
# 171 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
...
# 192 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/spinorbit.F90"
    end do
