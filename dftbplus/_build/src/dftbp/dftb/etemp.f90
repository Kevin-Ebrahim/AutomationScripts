# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90" 2
      ...
      do ispin = 1, size(eigenvals,dim=3)
        do i = 1, size(kWeight)
          do j = 1, size(eigenvals,dim=1)
            ...
            ! small input values
# 291 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90"
            electronCount = electronCount + kWeight(i)/(1.0_dp + exp(x))
# 293 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90"
          end do
        end do
      end do
    end if
        ...
        do i = 1, size(kWeight)
          do j = 1, size(eigenvals,dim=1)
            ...
            if (x<10.0_dp) then
              ! Where the compiler does not handle inf gracefully, trap the exponential function for
              ! small input values
# 348 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90"
              derivElectronCount = derivElectronCount + &
                  & (w*kWeight(i)) * (exp(x)/((1.0_dp + exp(x))**2))
# 351 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90"
            end if
          end do
        end do
      end do
      ...
      do iSpin = 1, size(eigenvals, dim=3)
        do i = 1, kpts
          do j = 1, size(eigenvals, dim=1)
            ...
            ! Where the compiler does not handle inf gracefully, trap the exponential function for
            ! small values
# 474 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90"
            filling(j, i, iSpin) = 1.0_dp / (1.0_dp + exp(x))
# 476 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/dftb/etemp.F90"
