# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90" 2
...
# 10 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90" 2
...
# 50 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 56 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 449 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    return
# 449 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  end if
...
# 470 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    if (allocated(dEi)) then
      call mpifx_allreduceip(env%mpi%globalComm, dEi, MPI_SUM)
    end if
# 474 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 744 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      & "src/dftbp/derivs/perturb.F90", 744)
# 744 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  return
# 746 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    end if
    if (allocated(dftbU) .or. allocated(onsMEs)) then
      allocate(dqBlockIn(orb%mOrb,orb%mOrb,nAtom,nSpin))
      allocate(dqBlockOut(orb%mOrb,orb%mOrb,nAtom,nSpin))
  ...
  if (errStatus%hasError()) then
# 790 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    return
# 790 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  end if

# 793 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
        ! Add up and distribute eigenvalue derivatives from each processor
        call mpifx_allreduceip(env%mpi%globalComm, dEi, MPI_SUM)
# 796 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  ...
  if (errStatus%hasError()) then
# 1264 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    return
# 1264 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  end if
  ...
  if (errStatus%hasError()) then
# 1281 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    return
# 1281 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  end if
  ...
  if (errStatus%hasError()) then
# 1303 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    return
# 1303 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  end if
...
# 1308 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      ! Add up and distribute density matrix contributions from each group
      call mpifx_allreduceip(env%mpi%globalComm, dRho, MPI_SUM)
# 1311 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  ...
  if (errStatus%hasError()) then
# 1354 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    return
# 1354 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  end if
...
# 1379 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
        ! Add up and distribute density matrix contribution from each group
        call mpifx_allreduceip(env%mpi%globalComm, dRhoExtra, MPI_SUM)
# 1382 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
        dRho(:,:) = dRho + dRhoExtra
      ...
      if (tSccCalc) then
        ...
        if ((.not. tConverged) .and. iSCCiter /= maxSccIter) then
          if (iSCCIter == 1) then
            if (allocated(hybridXc)) then
              dRhoIn(:) = dRhoOut
# 1435 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
              call denseMullikenRealBlacs(env, parallelKS, denseDesc, dRhoInSqr, SSqrReal, dqIn)
# 1439 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
            else
              dqIn(:,:,:) = dqOut
              dqInpRed(:) = dqOutRed
              if (allocated(dftbU) .or. allocated(onsMEs)) then
...
# 1452 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
              call denseMullikenRealBlacs(env, parallelKS, denseDesc, dRhoInSqr, SSqrReal, dqIn)
# 1456 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
            else
              call chrgMixerReal%mix(dqInpRed, dqDiffRed)
# 1459 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 1462 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 1508 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      & "src/dftbp/derivs/perturb.F90", 1508)
# 1508 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  return
# 1510 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      else
  ...
  subroutine init_perturbation(parallelKS, tolDegen, nOrbs, nKpts, nSpin, nIndepHam, maxFill,&
    ...
    if (allocated(hybridXc)) then
      ...
      sSqrReal(:,:) = 0.0_dp
# 1731 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 2039 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 2051 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    ...
    if (any(tMetallic)) then
  call errStatus%setError(-1, "Atom derivative perturbations are not currently supported for metallic systems",&
# 2059 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      & "src/dftbp/derivs/perturb.F90", 2059)
# 2059 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  return
# 2061 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    end if
  ...
  call errStatus%setError(-1, "Atom derivative perturbations are not currently supported for high-symmetry/degenerate systems",&
# 2067 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      & "src/dftbp/derivs/perturb.F90", 2067)
# 2067 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  return
# 2069 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      end if
    end do
...
# 2078 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 2138 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    ...
    if (allocated(hybridXc)) then
# 2154 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  call errStatus%setError(-1, "Range separation not supported for MPI at the moment", "src/dftbp/derivs/perturb.F90", 2154)
# 2154 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  return
# 2156 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
      allocate(SSqrReal(nOrbs, nOrbs))
      SSqrReal(:,:) = 0.0_dp
  ...
  if (errStatus%hasError()) then
# 2364 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    return
# 2364 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  end if
...
!                  & dEi, dPsiCmplx, iAt)
  ...
  call errStatus%setError(-1, "Shouldn't be here in dxAtom routine", "src/dftbp/derivs/perturb.F90", 2387)
# 2387 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
  return

          end if

# 2392 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
          ! Add up and distribute density matrix contributions from each group
          call mpifx_allreduceip(env%mpi%globalComm, dRho, MPI_SUM)
# 2395 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
          ...
          if (tSccCalc) then
            ...
            if ((.not. tConverged) .and. iSCCiter /= maxSccIter) then
              if (iSCCIter == 1) then
                if (allocated(hybridXc)) then
                  dRhoIn(:) = dRhoOut
# 2443 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
                  call denseMullikenRealBlacs(env, parallelKS, denseDesc, dRhoInSqr, SSqrReal, dqIn)
# 2447 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
                else
                ...
                if (allocated(hybridXc)) then
                  call chrgMixerReal%mix(dRhoIn, dqDiffRed)
# 2460 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
                  call denseMullikenRealBlacs(env, parallelKS, denseDesc, dRhoInSqr, SSqrReal, dqIn)
# 2464 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
                else
                  call chrgMixerReal%mix(dqInpRed, dqDiffRed)
# 2467 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
                  ! Synchronise charges in order to avoid mixers that store a history drifting apart
                  call mpifx_bcast(env%mpi%globalComm, dqInpRed)
# 2470 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
...
# 2523 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
    call mpifx_allreduceip(env%mpi%globalComm, dEi, MPI_SUM)
# 2525 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/perturb.F90"
