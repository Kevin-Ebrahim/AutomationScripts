# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/fermihelper.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/fermihelper.F90" 2
...
contains
  ...
  pure function theta(En, Em, sigma)
    ...
    x = (En - Em) / sigma
# 53 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/fermihelper.F90"
    theta = 1.0_dp / (1.0_dp + exp(x))
# 55 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/derivs/fermihelper.F90"
