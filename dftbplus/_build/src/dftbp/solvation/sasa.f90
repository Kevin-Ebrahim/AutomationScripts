# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/sasa.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/sasa.F90" 2
...
# 10 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/sasa.F90" 2
...
contains
  ...
  subroutine TSASACont_init(this, input, nAtom, species0, speciesNames, errStatus, latVecs)
    ...
    if (stat /= 0) then
  call errStatus%setError(stat, "Could not initialize angular grid for SASA model", "src/dftbp/solvation/sasa.F90", 202)
# 202 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/sasa.F90"
  return
    end if
