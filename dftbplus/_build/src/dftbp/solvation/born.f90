# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90" 2
...
# 10 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90" 2
...
# 254 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90"
    return
# 254 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90"
  end if
    end if
  ...
  subroutine addGradients(this, env, neighList, species, coords, img2CentCell, gradients, errStatus)
    ...
    if (allocated(this%sasaCont)) then
      call this%sasaCont%addGradients(env, neighList, species, coords, img2CentCell, gradients,&
          & errStatus)
  if (errStatus%hasError()) then
# 514 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90"
    return
# 514 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90"
  end if
  ...
  subroutine updateCharges(this, env, species, neighList, qq, q0, img2CentCell, orb, errStatus)
    ...
    if (allocated(this%sasaCont)) then
      call this%sasaCont%updateCharges(env, species, neighList, qq, q0, img2CentCell, orb,&
          & errStatus)
  if (errStatus%hasError()) then
# 637 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90"
    return
# 637 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/born.F90"
  end if
    end if
