# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90" 2
...
# 10 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90" 2
...
contains
  ...
  subroutine TCosmo_init(this, input, nAtom, species0, speciesNames, errStatus, latVecs)
    ...
    if (stat /= 0) then
  call errStatus%setError(stat, "Could not initialize angular grid for COSMO model", "src/dftbp/solvation/cosmo.F90", 209)
# 209 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  return
    end if
...
# 222 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
    return
# 222 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  end if
    end if
  ...
  subroutine addGradients(this, env, neighList, species, coords, img2CentCell, gradients, errStatus)
    ...
    if (allocated(this%sasaCont)) then
      call this%sasaCont%addGradients(env, neighList, species, coords, img2CentCell, gradients,&
          & errStatus)
  if (errStatus%hasError()) then
# 387 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
    return
# 387 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  end if
    end if
  ...
  if (errStatus%hasError()) then
# 398 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
    return
# 398 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  end if
  ...
  subroutine updateCharges(this, env, species, neighList, qq, q0, img2CentCell, orb, errStatus)
    ...
    if (allocated(this%sasaCont)) then
      call this%sasaCont%updateCharges(env, species, neighList, qq, q0, img2CentCell, orb,&
          & errStatus)
  if (errStatus%hasError()) then
# 521 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
    return
# 521 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  end if
    end if
  ...
  if (errStatus%hasError()) then
# 534 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
    return
# 534 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  end if
  ...
  if (errStatus%hasError()) then
# 545 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
    return
# 545 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  end if
  ...
  subroutine solveCosmoDirect(ddCosmo, cart, phi, glm, sigma, restart, errStatus)
    ...
    if (iStatus /= 0) then
  call errStatus%setError(iStatus, 'cosmo: [2] failed allocation', "src/dftbp/solvation/cosmo.F90", 739)
# 739 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  return
    endif
    ...
    if (cart) then
      ...
      if (iStatus /= 0) then
  call errStatus%setError(iStatus, 'cosmo: [3] failed allocation', "src/dftbp/solvation/cosmo.F90", 749)
# 749 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  return
      endif
      ...
      if (iStatus /= 0) then
  call errStatus%setError(iStatus, 'cosmo: [1] failed deallocation', "src/dftbp/solvation/cosmo.F90", 763)
# 763 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  return
      endif
    ...
    ! check solution
    if (.not.ok) then
  call errStatus%setError(-1, 'direct ddCOSMO did not converge!', "src/dftbp/solvation/cosmo.F90", 788)
# 788 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  return
    endif
  ...
  subroutine solveCosmoAdjoint(ddCosmo, psi, sigma, restart, errStatus, accuracy)
    ...
    ! check solution
    if (.not.ok) then
  call errStatus%setError(-1, 'adjoint ddCOSMO did not converge!', "src/dftbp/solvation/cosmo.F90", 846)
# 846 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/solvation/cosmo.F90"
  return
    endif
