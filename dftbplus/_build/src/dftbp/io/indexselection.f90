# 1 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
!--------------------------------------------------------------------------------------------------!
...
# 9 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90" 2
...
# 10 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90" 2
...
# 199 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 199 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
  ...
  if (errStatus%hasError()) then
# 216 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 216 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
  ...
  if (errStatus%hasError()) then
# 223 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 223 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
      end do
  ...
  block
# 227 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 227 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Unexpected token ''', A, ''' found')") token%content
# 227 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%syntaxError, trim(message), "src/dftbp/io/indexselection.F90", 227)
# 227 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 227 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 229 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    end if
  ...
  if (errStatus%hasError()) then
# 246 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 246 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
  ...
  if (errStatus%hasError()) then
# 253 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 253 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
      end do
  ...
  if (errStatus%hasError()) then
# 276 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 276 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
      selected(:) = .not. buffer
  ...
  if (errStatus%hasError()) then
# 280 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 280 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
    end if
  ...
  if (errStatus%hasError()) then
# 300 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 300 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
  ...
  if (errStatus%hasError()) then
# 304 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    return
# 304 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end if
      if (token%type /= tokenTypes_%close) then
  call errStatus%setError(errors%syntaxError, "Missing closing parenthesis ')'", "src/dftbp/io/indexselection.F90", 306)
# 306 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
      end if
    else
  block
# 309 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 309 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Unexpected token ''', A, ''' found')") token%content
# 309 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%syntaxError, trim(message), "src/dftbp/io/indexselection.F90", 309)
# 309 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 309 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 311 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    end if
    call tokenizer%getNextToken(token)
  ...
  subroutine evalSelector_(selector, selection, selected, errStatus)
    ...
    if (iFirstChar  >= ichar('0') .and. iFirstChar <= ichar('9') .or. firstChar == '-') then
      ...
      if (seppos > 0) then
        ...
        if (iostat /= 0) then
  block
# 339 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 339 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Non-integer index ''', A,  '''')") selector(: seppos - 1)
# 339 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%syntaxError, trim(message), "src/dftbp/io/indexselection.F90", 339)
# 339 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 339 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 341 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
        end if
        read(selector(seppos + 1 :), *, iostat=iostat) iLast
        if (iostat /= 0) then
  block
# 344 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 344 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Non-integer index ''', A,  '''')") selector(seppos + 1 :)
# 344 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%syntaxError, trim(message), "src/dftbp/io/indexselection.F90", 344)
# 344 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 344 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 346 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
        end if
      else
        read(selector, *, iostat=iostat) iFirst
        if (iostat /= 0) then
  block
# 350 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 350 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Non-integer index ''', A,  '''')") selector
# 350 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%syntaxError, trim(message), "src/dftbp/io/indexselection.F90", 350)
# 350 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 350 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 352 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
        end if
        iLast = iFirst
      end if
  ...
  block
# 358 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 358 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Out of bounds index value ', I0)") iFirst
# 358 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%invalidSelector, trim(message), "src/dftbp/io/indexselection.F90", 358)
# 358 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 358 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 360 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
      end if
      iLastNorm = normalizedIndex_(iLast, selection%selectionRange, selection%indexRange,&
          & selection%backwardIndexing)
      if (iLastNorm == 0) then
  block
# 364 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 364 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Out of bounds index value ', I0)") iLast
# 364 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%invalidSelector, trim(message), "src/dftbp/io/indexselection.F90", 364)
# 364 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 364 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 366 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
      end if
    ...
    ! Non-numerical value. If this is an atom selection, try to interpret it as species name.
      ...
      if (iSpecies == 0) then
  block
# 377 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 377 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Invalid species name ''', A, '''')") trim(selector)
# 377 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%invalidSelector, trim(message), "src/dftbp/io/indexselection.F90", 377)
# 377 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 377 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 379 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
      end if
  ...
  block
# 386 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    character(1024) :: message
# 386 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    write(message, "('Invalid index selector ''', A, '''')") trim(selector)
# 386 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  call errStatus%setError(errors%syntaxError, trim(message), "src/dftbp/io/indexselection.F90", 386)
# 386 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  end block
# 386 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
  return
# 388 "/home/witsa/AutomationScripts/dftbplus/dftbplus/src/dftbp/io/indexselection.F90"
    end if
